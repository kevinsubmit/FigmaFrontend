...
### 本版更新（预约体验优化）
- ✅ 预约可用时间：基于门店营业时间 + 技师空闲 + 预约冲突
- ✅ 当天预约限制：必须晚于当前时间 + 30 分钟
- ✅ 预约摘要：服务/价格/时长/地址/备注预览
- ✅ 取消/改期规则：提前 2 小时截止并自动禁用
- ✅ 预约详情 UI：Reschedule/Notes/导航入口优化
- ✅ 店铺列表 UI：排序/筛选交互优化
- ✅ 首页灵感流：标签筛选 + 标签搜索（按标签关键字）
- ✅ 图片详情页：相似推荐 + 预约 CTA 强化
