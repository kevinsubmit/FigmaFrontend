...
SMOKE_CASES: tuple[SmokeCase, ...] = (
    ...
    SmokeCase(
        key="appointment-service-items",
        label="Appointment Service Items Regression Smoke",
        script_path="test_appointment_service_items_regression.py",
    ),
    SmokeCase(
        key="home-search",
        label="Home Search Regression Smoke",
        script_path="test_home_search_regression.py",
    ),
    SmokeCase(
    ...
    SmokeCase(
        key="daily-checkin",
        label="Daily Check-In Regression Smoke",
        script_path="test_daily_checkin_regression.py",
    ),
)
...
def write_results_file(
    ...
    payload = {
        ...
        "suite": "backend-regression-smokes",
        "status": suite_status,
...
def run_case(case: SmokeCase, root: Path) -> SmokeRunResult:
    ...
    if not script.is_file():
        ...
        return SmokeRunResult(
            ...
            error_message=f"Smoke script not found: {script}",
        )
