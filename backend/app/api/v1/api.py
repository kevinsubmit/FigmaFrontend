...
from app.api.v1.endpoints import auth, stores, services, appointments, technicians, store_hours, technician_unavailable, notifications, reviews, upload, review_replies, users, store_portfolio, store_holidays, points, coupons, referrals, pins, gift_cards, promotions, store_admin_applications, risk, customers, security, logs, vip, dashboard, app_version, profile, support_contact
...
api_router.include_router(store_admin_applications.router, prefix="/store-admin-applications", tags=["Store Admin Applications"])
...
api_router.include_router(support_contact.router, prefix="/support-contact", tags=["Support Contact"])
