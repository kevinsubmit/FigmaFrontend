...
class Appointment(Base):
    ...
    coupon_discount_amount = Column(Float, nullable=False, default=0)
    gift_card_used_amount = Column(Float, nullable=False, default=0)
    cash_paid_amount = Column(Float, nullable=False, default=0)
    final_paid_amount = Column(Float, nullable=False, default=0)
    points_earned = Column(Integer, nullable=False, default=0)
    points_reverted = Column(Integer, nullable=False, default=0)
    settlement_status = Column(String(20), nullable=False, default="unsettled", index=True)
